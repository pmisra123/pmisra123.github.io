...
<div class="about-grid">
  <div class="about-photo">
    <img src="/assets/images/photo.jpg" alt="Prakhar Misra">
  </div>
  <div class="about-text">
    <p>I am a Ph.D. candidate in International Political Economy at the <a href="https://www.sais-jhu.edu/">School of Advanced International Studies (SAIS)</a>, Johns Hopkins University. My research has been supported by grants from <a href="https://www.sais-jhu.edu/">Johns Hopkins SAIS</a>, <a href="https://guptaklinsky.sais-jhu.edu/">Gupta-Klinsky India Institute</a>, <a href="https://www.theihs.org/">Institute for Humane Studies</a>, <a href="https://www.indiastudies.org/">American Institute for Indian Studies</a>, <a href="https://apsanet.org/">APSA Centennial Centre for Political Science and Public Affairs</a>, and <a href="https://www.sawtooth.com/">Sawtooth's Academic Grants Program</a>.</p>
    <p>My research examines the sub-national political economy of state capacity in developing countries, with a focus on the institutional processes that shape the recruitment and allocation of government personnel. Using a mixed-methods approach, I analyze how bureaucratic staffing patterns emerge and persist within different political and administrative contexts.</p>
    <p>I use mixed-methods approaches, combining administrative data from government documents with data scraped from newspapers and courts to study recruitment policies and institutional bottlenecks; I complement this with qualitative fieldwork and survey experiments to test hypotheses generated from these data sources.</p>
...
<div class="project-item">
  ...
  <div class="project-desc">A public history project documenting India's economic transformation from socialist planning to market-oriented reforms in 1991. The project revives ideas and policies from that pivotal period, targeting audiences born after 1991 who have no memory of the pre-reform economy. I authored research papers, coordinated essays, designed timelines and data visualizations, anchored lectures, and created op-eds and podcasts.</div>
  <a class="project-link" href="https://www.the1991project.com/" target="_blank">the1991project.com →</a>
</div>

<div class="project-item">
  <div class="project-name">Data Governance Network</div>
  <div class="project-desc">A two-year initiative funded by Omidyar Network to bridge differing perspectives on digital governance policy in India during a period of active regulatory discussion. The network brought together 8 organizations (think-tanks and NGOs), produced 35 research papers and policy briefs, held quarterly roundtables, and submitted findings to parliamentary committees. I led the initiative in year two, selecting research organizations, coordinating output, managing communications, and liaising with policymakers.</div>
  <a class="project-link" href="https://datagovernance.org/" target="_blank">datagovernance.org →</a>
</div>

<div class="project-item">
  <div class="project-name">Developing Infrastructure for Creating Employment (DICE)</div>
  <div class="project-desc">An IDFC Institute survey project examining the employment impact of infrastructure investment across India, funded by the Ford Foundation. The research combined nightlights data analysis, a 2,500-firm survey across 18 districts, and focus group discussions — with particular attention to peri-urban regions. The final report was launched by Minister Nitin Gadkari.</div>
  <a class="project-link" href="https://www.idfcinstitute.org/projects/transitions/developing-infrastructure-for-creating-employment-dice/" target="_blank">IDFC Institute →</a>
</div>
</section>
...
<div class="media-item">
  ...
  <div class="media-outlet">PuliyaBaazi</div>
</div>

<div class="media-item">
  <span class="media-title"><a href="https://www.discoursemagazine.com/economics/2021/08/19/ideas-of-india-the-1991-project/" target="_blank">The 1991 Project</a></span>
  <div class="media-outlet">Ideas for India</div>
</div>

<div class="media-item">
  <span class="media-title"><a href="https://ivmpodcasts.com/the-pragati-podcast-episode-list/2019/12/4/ep-121-improving-indias-state-capacity" target="_blank">Improving India's State Capacity</a></span>
  <div class="media-outlet">The Pragati Podcast, Ep. 121</div>
</div>

<div class="media-item">
  <span class="media-title"><a href="https://ivmpodcasts.com/puliyabaazi-episode-list/2020/4/16/ep-61-" target="_blank">सरकारी तंत्र की काबिलियत के मायने (Measuring State Capacity in India)</a></span>
...
<div class="media-item">
  ...
  <div class="media-outlet">Blavatnik School of Government, University of Oxford</div>
</div>

<div class="media-item">
  <span class="media-title"><a href="https://www.youtube.com/watch?v=XiUwWi-gW70" target="_blank">Data Trusts: Is India Ready?</a></span>
  <div class="media-outlet">Data Governance Network (moderator)</div>
</div>

<div class="media-item">
  <span class="media-title"><a href="https://www.youtube.com/watch?v=A5bjdf2jfgo" target="_blank">AI Futures</a></span>
  <div class="media-outlet">Young Thinker's Conference</div>
</div>

<div class="media-item">
  <span class="media-title"><a href="https://www.youtube.com/watch?v=pcK3UTnhHQc" target="_blank">Using Technology to Improve India's Social Protection System</a></span>
  <div class="media-outlet">Data Governance Network (moderator)</div>
</div>

<div class="media-item">
  <span class="media-title"><a href="https://www.youtube.com/watch?v=s7lUEIvTjto" target="_blank">Open Data in India</a></span>
  <div class="media-outlet">Arthan Social Forum</div>
</div>

<div class="media-item">
  <span class="media-title"><a href="https://www.youtube.com/watch?v=6N3vcJXJhJM" target="_blank">Unpacking the Non-Personal Data Report: Innovation Catalyst or Regulatory Overreach?</a></span>
  <div class="media-outlet">Data Governance Network (moderator)</div>
</div>
</section>
...
<ul class="writings-list">
  <li><a href="https://www.fiftytwo.in/shortfall" target="_blank">"Shortfall"</a> &mdash; <span class="outlet">FiftyTwo.in, February 2023</span></li>
</ul>
...
<ul class="writings-list">
  ...
  <li><a href="https://www.livemint.com/Politics/Ey6VRIMAozRK082XGruVbP/Finance-ministry-has-a-poor-forecasting-record.html" target="_blank">"Finance Ministry has a Poor Forecasting Record"</a> (with Sharmadha Srinivasan and Niranjan Rajadhyaksha) &mdash; <span class="outlet">Mint, January 2019</span></li>
</ul>
...
<p style="margin-top: 16px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 0.85em; color: #666;">
  <strong>Hindi:</strong> Selected articles in <em>The Quint Hindi</em>, <em>The Quint</em>, <em>News Laundry</em>, and <em>Scroll</em>.
</p>
</section>
